...
# 🔢 Mittelwerte getrennt berechnen
...
lemma_vectors = {lemma: nlp(lemma) for lemma in set(words) if nlp(lemma).has_vector}

# 🔗 Kategorisiere Wörter
assignment = []
...
with open(output_txt_path, "w", encoding="utf-8") as out:
    out.write("📊 Analyse der semantischen Wortkategorien (alle Wortarten)\n")
    out.write("=" * 60 + "\n\n")
    out.write(f"Verwendete relevante Wörter im Text: {len(words)}\n")
